...
async function setup() {
  ...
  await Publisher.create({ publisherid: 6, publishername: 'Martin Knight', publisherdesc: 'Martin Knight description' });
  ...
  await Product.create({ productid: 4, publisherid: 4, productname: 'Essential NPCs', productimage: 'EssentialNPCs.png', productdesc: '', productprice: 19.99 });
  await Product.create({ productid: 5, publisherid: 5, productname: 'Achtung! Cthulhu 2d20 Starter Set (PDF)', productimage: 'AchtungCthulhu.png', productdesc: 'Welcome to the Secret War! In this Achtung! Cthulhu 2d20 starter set, you’ll get your first glimpse into the hidden globe-spanning conflict between the forces of good and evil! Only you and your scrappy band of heroes can defeat the malignant forces of the occult, and the malevolent might of their Mythos masters!', productprice: 20.00 });
  await Product.create({ productid: 6, publisherid: 5, productname: 'Fallout: The Roleplaying Game Wanderers Guide Book (PDF)', productimage: 'Fallout.png', productdesc: 'Journeying through the devastated wasteland, resourceful wanderers from all walks of life travel from settlement to settlement in order to survive and, sometimes, even thrive!', productprice: 22.00 });
  await Product.create({ productid: 7, publisherid: 6, productname: 'D100 Space - Galaxy Builder (Book 2)', productimage: 'D100Space.png', productdesc: 'The D100 Space Galaxy Builder (Book 2) adds to D100 Space a way to create and explore new and fascinating galaxies. Your captain will travel the galaxy, interacting with star systems, space stations, and military docks; and explore unique and dangerous planets in search of adventure. They will discover missions and may even have events sprung on them as they explore the darkest reaches of space.', productprice: 17.45 });
